...
<h1>Dashboard</a> <small>Statistics Overview</small></h1>
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
     <li class="breadcrumb-item active" aria-current="page"></i> Dashboard</li>
  </ol>
</nav>
  ...
  <div class="col-sm-4">
     <div class="card text-white bg-warning mb-3">
      ...
      <div class="list-group-item-primary list-group-item list-group-item-action">
        <div class="row">
          <div class="col-sm-8">
            <a href="all-student.php"><p class="">All Students</p>
          </div>
          <div class="col-sm-4">
