...
<html lang="en">
  ...
  <body>
	...
	<h1 class="text-center">Welcome to Enrollment System!</h1>
          <h2 class="text-center">Login Account</h2><hr><br>
            ...
            <div class="col-md-4 offset-md-4">
             	<form method="POST" action="">
				  ...
				  <div class="text-center">
				    ...
				    <p>Don’t have an account? Register here!<a href="register.php"> Click Here</a></p>
				  </div>
				</form>
            </div>
          </div>
