...
?>
<h1 class="text-primary"></i>  Add Student<small class="text-warning"> Add New Student!</small></h1>
	...
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <input name="pcontact" type="text" class="form-control" id="pcontact" pattern="01[5|6|7|8|9][0-9]{8}" value="<?= isset($pcontact)? $pcontact: '' ; ?>" placeholder="01........." >
	  	</div>
	  	<div class="form-group">
	  	...
	  	<div class="form-group text-center">
		    <input name="addstudent" value="Add Student" type="submit" class="btn btn-secondary">
	  	</div>
	 </form>
</div>
</div>